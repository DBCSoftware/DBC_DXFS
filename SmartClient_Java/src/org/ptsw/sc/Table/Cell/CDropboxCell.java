...
public class CDropboxCell extends TableCell<RowData, CDropBoxTableItem> {

	@SuppressWarnings("unused")
	private final double colWidth;
	
	@SuppressWarnings({ })
	public CDropboxCell (Column<?,?> column) throws Exception {
	...
	@Override
	protected void updateItem(CDropBoxTableItem item, boolean empty) {
