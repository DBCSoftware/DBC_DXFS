...
public final class Util
{
	...
	static final Logger logger = Logger.getLogger("com.dbcswc.fs");
	
	public static String currentdatetime()
	{
		return fmt.format(new Date()).substring(0, 16);
	}
	 ...
	 * @return
	 */
	static public String stos(String value, int size)
	{
		int i1 = 0;
		...
		if (i1 < size) {
			...
			if (i1 > 0) value.getChars(0, i1, work, 0);
			while (i1 < size) work[i1++] = ' ';
			return String.valueOf(work, 0, size);
		}
		return value.substring(0, size);
	}
	
	static public String stonums(String value, int size1, int size2)
	{
	...
	public static String itoszf(int number, int count) throws Exception
	{
		int i1;
	...
	public static void itoca(int number, char[] dest, int destoff, int count) throws Exception
	{
		int i1, i2;
		boolean negative = false;
		i2 = destoff + count - 1;
	...
	public static int catoi(char[] source, int sourceoff, int count) throws Exception
	{
		int i1, i2, number;
		char c1;
